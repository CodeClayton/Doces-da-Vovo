...
app.post('/submit',(req,res) => {
    ...
    //utilizando ela previne o sql injection devido o valor ser inserido diretamente dentro de um insert.
        ...
        const html = `
            ...
            <body>
                ...
                <main>
                    ...
                    <button type="submit" class="buttonReturn">Retornar</button>
                    </form>
                </main>
                <footer>
